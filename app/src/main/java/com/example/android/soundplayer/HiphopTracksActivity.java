...
public class HiphopTracksActivity extends MusicControlBasic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hiphop_tracks);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setActionBarTitle(getString(R.string.hiphop));
        getCurrentPlayingLinearLayout().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HiphopTracksActivity.this, CurrentPlayingActivity.class);
