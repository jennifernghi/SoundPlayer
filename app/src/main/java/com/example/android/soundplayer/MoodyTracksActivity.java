...
public class MoodyTracksActivity extends MusicControlBasic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moody_tracks);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setActionBarTitle(getString(R.string.moody));
        getCurrentPlayingLinearLayout().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MoodyTracksActivity.this, CurrentPlayingActivity.class);
