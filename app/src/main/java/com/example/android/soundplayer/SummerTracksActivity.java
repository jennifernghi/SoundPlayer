...
public class SummerTracksActivity extends MusicControlBasic {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_summer_tracks);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setActionBarTitle(getString(R.string.summer));
        getCurrentPlayingLinearLayout().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SummerTracksActivity.this, CurrentPlayingActivity.class);
